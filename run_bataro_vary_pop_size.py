...
if __name__ == '__main__':
	...
	README = 'Array signature: (n_simulations, n_example_ensembles, N). In this data 10 simulations are used, and 20 random (5-target) ensembles are used for each size.'
	np.savez(savedir + 'fig3_results_error_vs_population_size_%i'%N, results_nuclear=results_array_nuclear_vary_pop, results_calibrated=results_array_calib_vary_pop, target_vectors=target_vectors, README=README)
